...
<form class="exam-form form-inline" action="teacher_manage_addStudent" method="post">
	<h4>添加单个学生</h4>
...
<form class="exam-form form-inline" action="teacher_manage_serach_student2" method="post">
	<h4>查找学生信息</h4>
	<input type="text" name="snumber" placeholder="学号" size="20" />
	<input type="text" name="sname" placeholder="姓名" size="20" />
	<input type="text" name="sclass" placeholder="班级" size="20" />
